...
const AdminSidebar = () => {
  return (
    <div className='hidden md:block md:fixed h-full  w-[15%]  mr-[85%] border-r-2'>
        
        <a href="/Admindashboard">
            <h1 className='text-gray-800 md:text-2xl md:mt-4 md:justify-center flex mb-[50px] '> AWYETU</h1>
        </a>
